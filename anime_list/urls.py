...
from .views import anime_list, anime_detail, category_detail, toggle_favorite, favorite_anime, remove_favorite, popular_anime, search_anime
...
urlpatterns = [
    ...
    path('popular/', popular_anime, name='popular_anime'),
